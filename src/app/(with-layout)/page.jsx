  ...
  return (
    ...
    >
      ...
      <div className='w-screen   shadow-2xl'>
            ...
            {/* <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">obten prestamos agiles sin mucha burocracia</p> */}

        <AutoplaySlider className='relative h-[120vw]' cssModule={{ backgroundColor: 'red' }} play={true} interval={3000} buttons={false} bullets={false}>


          <div className='relative bg-[#ffffff] h-full w-full text-black p-5 shadow-2xl'>
            <p class="relative mb-4 text-3xl font-extrabold text-gray-900  md:text-5xl lg:text-6xl">Con <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">TRUEK APP</span> obten prestamos agiles sin mucha burocracia.</p>
            <img src="/prestar.png" className='relative' alt="" />
          </div>
          <div className='bg-white h-full w-full text-black p-5 shadow-2xl'>
            <p class="mb-4 text-3xl font-extrabold text-gray-900  md:text-5xl lg:text-6xl">Con <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">TRUEK APP</span> obten prestamos para semanas o meses.</p>
            <img src="/prestar.png" alt="" />
          </div>
          <div className='bg-white h-full w-full text-black p-5 shadow-2xl'>
            <p class="mb-4 text-3xl font-extrabold text-gray-900  md:text-5xl lg:text-6xl">Con <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">TRUEK APP</span> conviertete en un inversor y gana hasta un 20% de interes anual.</p>

            <img src="/invertir.png" alt="" />
          </div>
          <div className='bg-white h-full w-full text-black p-5 shadow-2xl'>
            <p class="mb-4 text-3xl font-extrabold text-gray-900  md:text-5xl lg:text-6xl">Con <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">TRUEK APP</span> puedes invertir y ganar intereses en 3 meses.</p>
